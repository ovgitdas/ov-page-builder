...
const cloneTag = (tag: Tag): Tag => ({
  ...
  children: !!tag.children
    ? "tags" in tag.children
      ? { tags: tag.children.tags.map(cloneTag) }
...
export const getChildrenType = (tag: Tag) =>
  !tag || !tag.children
    ? ""
    : "tags" in tag.children
    ? "tags"
    : "imageCarousel" in tag.children
    ? "imageCarousel"
    : "itemCarousel" in tag.children
    ? "itemCarousel"
    : "linkImage" in tag.children
    ? "linkImage"
    : "text" in tag.children
    ? "text"
    : "";
